...
L'evidenza empirica di profilazione in Figura \ref{fig:efficienza} palesa il radicale divario algoritmico. Mentre la variante a pila soffre in scalabilità all'allargarsi dei lati dell'arena ($L$) o all'ostruzionismo dettato dall'intensificarsi del riempimento cromatico ($p_{col}$), l'algoritmo Hoshen-Kopelman assorbe invariato l'aumento della massa critica pre-soglia.
...
L'indagine espone tangibilmente i teoremi asintotici di frontiera (Rif. Figura \ref{fig:termodinamica}):
\begin{itemize}
